...
with open(r'/home/jayas/PycharmProjects/RevMeUp/ProductCreationBatch/Flipkart/Flipkart_electronics/Speaker.json','r') as flip_file:
    prod_flip = json.load(flip_file)
with open(r'/home/jayas/PycharmProjects/RevMeUp/ProductCreationBatch/Croma/Croma_electronics/Speaker.json','r') as croma_file:
