...
with open(r'/home/jayas/PycharmProjects/RevMeUp/ProductCreationBatch/Flipkart/Flipkart_electronics/Tablet.json','r') as flip_file:
    prod_flip = json.load(flip_file)
with open(r'/home/jayas/PycharmProjects/RevMeUp/ProductCreationBatch/Croma/Croma_electronics/Tablet.json','r') as croma_file:
